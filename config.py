...
argparser.add_argument('--train_file', type=str, default='./preprocess/dataset/split/train.list', help='Train list')
argparser.add_argument('--val_file', type=str, default='./preprocess/dataset/split/val.list', help='Validation list')
...
argparser.add_argument('--device_id', type=int, default=1, help='Device id')
argparser.add_argument('--exp_path', type=str, default='evalai_test/output', help='Path to results')
argparser.add_argument('--checkpoint', type=str, default='evalai_test/ttm-best.pth', help='Checkpoint to load')
